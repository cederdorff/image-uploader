...
<body data-ng-app="imageUploader">
  ...
  <div class="container">
    ...
    <div data-ng-controller="ImageController">
      <a data-ng-repeat="file in queue" data-ng-class="{'processing': file.$processing()}" data-ng-href="{{file.url}}" title="{{file.name}}" download="{{file.name}}" data-gallery><img data-ng-src="{{file.thumbnailUrl}}" alt=""></a>
    </div>
