<div class="row">
  <div class="col-md-4 paulAside">
    ...
    <div> <img src="img/Poul Cederdorff.jpg" alt="Paul Cederdorff" class="img-responsive imgPort">
    ...
    <div class="previews" data-ng-controller="imageGalleryController">
      <div class="ng-cloak">
        <div data-ng-repeat="file in queue | orderBy:'created_at':true" data-ng-class="{'processing': file.$processing()}">
          ...
          <div>
            <p class="name" data-ng-switch data-on="!!file.url"> <span data-ng-switch-when="true" data-ng-switch data-on="!!file.thumbnailUrl"> <a data-ng-switch-when="true" data-ng-href="{{file.url}}" title="{{file.name}}" download="{{file.name}}" data-gallery></a> <a data-ng-switch-default data-ng-href="{{file.url}}" title="{{file.name}}" download="{{file.name}}"></a> </span> <span data-ng-switch-default>{{file.name}}</span> </p>
          </div>
        </div>
      </div>
    </div>
